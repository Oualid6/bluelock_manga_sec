...
const Legal: React.FC<LegalProps> = ({ type }) => {
        ...
        switch (type) {
            case 'privacy':
                return {
                    ...
                    content: (
                        <>
                            <p className="mb-4">At Jujutsu Kaisen Manga Hub, accessible from our website, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Jujutsu Kaisen Manga Hub and how we use it.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">Log Files</h2>
                            <p className="mb-4">Jujutsu Kaisen Manga Hub follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">Cookies and Web Beacons</h2>
                            <p className="mb-4">Like any other website, Jujutsu Kaisen Manga Hub uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">Google DoubleClick DART Cookie</h2>
                            <p className="mb-4">Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads" className="text-jjk-red hover:underline" target="_blank" rel="noopener noreferrer">https://policies.google.com/technologies/ads</a></p>
                ...
                return {
                    ...
                    content: (
                        <>
                            ...
                            <p className="mb-4">Please submit your info to: <strong>legal@rejjk.com</strong></p>
            ...
            case 'disclaimer':
                return {
                    ...
                    content: (
                        <>
                            <p className="mb-4">If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at info@rejjk.com.</p>
                            ...
                            <p className="mb-4">Jujutsu Kaisen Manga Hub is a non-profit fan-made website dedicated to the Jujutsu Kaisen series. We are <strong>not affiliated with, endorsed, sponsored, or specifically approved by Gege Akutami, Shueisha, or any of their partners</strong>. All characters, images, names, and related indicia are trademarks of their respective owners.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">Proprietary Rights</h2>
                            <p className="mb-4">Jujutsu Kaisen and all related characters and elements are distinct from this website. This site acts merely as a database and community hub for fans. We do not claim ownership over the manga content provided.</p>
            ...
            case 'terms':
                return {
                    ...
                    content: (
                        <>
                            <p className="mb-4">Welcome to Jujutsu Kaisen Manga Hub! These terms and conditions outline the rules and regulations for the use of our Website.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">1. Acceptance of Terms</h2>
                            <p className="mb-4">By accessing this website we assume you accept these terms and conditions. Do not continue to use Jujutsu Kaisen Manga Hub if you do not agree to take all of the terms and conditions stated on this page.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">2. License</h2>
                            <p className="mb-4">Unless otherwise stated, Jujutsu Kaisen Manga Hub and/or its licensors own the intellectual property rights for all material on Jujutsu Kaisen Manga Hub. All intellectual property rights are reserved. You may access this from Jujutsu Kaisen Manga Hub for your own personal use subjected to restrictions set in these terms and conditions.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">3. User Content</h2>
                            <p className="mb-4">Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website (Comments). Jujutsu Kaisen Manga Hub does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Jujutsu Kaisen Manga Hub,its agents and/or affiliates.</p>

                            <h2 className="text-xl font-bold mt-6 mb-3">4. Limitation of Liability</h2>
                            <p className="mb-4">In no event shall Jujutsu Kaisen Manga Hub, nor any of its officers, directors and employees, be held liable for anything arising out of or in any way connected with your use of this Website whether such liability is under contract. Jujutsu Kaisen Manga Hub, including its officers, directors and employees shall not be held liable for any indirect, consequential or special liability arising out of or in any way related to your use of this Website.</p>
                        </>
                    )
                };
        }
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-16 min-h-screen">
            <SEOHead title={`${title} - Jujutsu Kaisen Manga`} description={`Read our ${title}.`} />
