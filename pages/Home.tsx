...
const Home: React.FC = () => {
  ...
  const shareData = {
    ...
    text: 'Check out Blue Lock Manga online! Read all chapters in HD.',
  ...
  const shareLinks = [
    ...
    },
    {
      ...
      url: `https://www.reddit.com/submit?url=${encodeURIComponent(shareData.url)}&title=${encodeURIComponent(shareData.title)}`,
      color: 'bg-[#FF4500]'
    }
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        canonicalUrl={`https://bluelockhub.com/${lang}`}
        schema={{
          "@context": "https://schema.org",
          "@type": "WebSite",
          "name": "Blue Lock Manga",
          "url": `https://bluelockhub.com/${lang}`,
        }}
      />
          ...
          <div className="manga-hero-card w-full bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 md:p-8 mb-10 shadow-2xl">
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex lg:flex-col justify-center items-center gap-8 min-w-[140px]">
                ...
                >
                  <Share2 className="w-8 h-8 text-bb-blue mx-auto mb-2 fill-bb-blue group-hover:scale-110 transition-transform" />
                  <span className="block text-2xl font-bold text-white">Share</span>
                  <span className="text-xs text-gray-500 uppercase tracking-wide group-hover:text-bb-blue transition-colors">Spread the Ego</span>
                </button>
      ...
      {isShareModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          {/* Modal Content */}
          <div className="relative bg-bb-dark border border-white/10 w-full max-w-sm rounded-2xl p-6 shadow-2xl animate-in fade-in zoom-in duration-300">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-white">Share Manga</h3>
              <button 
                onClick={() => setIsShareModalOpen(false)}
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {shareLinks.map((link) => (
                <a
                  ...
                  className="flex flex-col items-center justify-center p-4 rounded-xl bg-white/5 border border-white/5 hover:border-bb-blue/50 hover:bg-white/10 transition-all group"
                >
                  <div className={`p-2 rounded-lg ${link.color} text-white mb-2 group-hover:scale-110 transition-transform`}>
                    {link.icon}
                  </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-bb-blue hover:bg-blue-700 text-white font-bold transition-colors mb-2"
            >
              <LinkIcon size={18} />
              Copy Link
            </button>
