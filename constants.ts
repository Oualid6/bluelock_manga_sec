...
// Generate integer chapters 1-351
const integerChapters: Chapter[] = Array.from({ length: 351 }, (_, i) => {
  const number = i + 1;
  ...
  return {
    ...
    pages: number === 351 ? [] : Array.from({ length: number >= 350 ? 23 : (number >= 347 ? 20 : (number === 346 ? 8 : (number === 345 ? 20 : 80))) }, (_, p) =>
...
export const ARCS: Arc[] = [
  ...
  },
  {
    ...
    chapterStart: 153,
    chapterEnd: 351, // includes 346.2 (Part 2)
